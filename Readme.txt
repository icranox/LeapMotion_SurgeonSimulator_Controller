...
This is my second Surgeon Simulator Leap controller. The first one was kind of an abomination (and I probably don't have it anymore) but this one turned out quite nice ;)
...
In line 50 and 51 in the LeapListener.h you can change the hights of both left and right click
...
Just throw in the stuff from your SDK copy and it is ready to go. You will need: Leap.h, LeapMath.h, Leap.lib and the leap.dll